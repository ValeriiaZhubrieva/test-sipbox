...
const ua = { "week": ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Нд"], "month": ["Січень", "Лютий", "Березень", "Квітень", "Травень", "Червень", "Липень", "Серпень", "Вересень", "Жовтень", "Листопад", "Грудень"], "button": "Застосувати", "year": "Рік (4 цифри)" };
